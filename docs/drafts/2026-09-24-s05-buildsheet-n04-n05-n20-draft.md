🔲draft 生成时间：2026-09-24T14:45:00Z（Asia/Bangkok 2026-09-24 21:45 +07:00）；本稿合并 2026-09-24T11:52:01Z 首稿与其后 N20 接线、marker 订正两轮变更，并补入 2026-09-24 14:35Z 版本扫描所得两项。
...
执行顺序依 Kayden 原文：「先把主单转「已取消」，再取消未关子单——反过来先关子单，模式五会抢先把主单判成「已完成」」

🔲出处 OSD-116 c50445；本事项登记依据 04.3 v35 §六。
...
🔲**补注既有「B6 上下级解析」段中「未定义哪些码计为缺位……须经白话对齐向 Felix 确认本流程口径」一句**：【2026-09-24 补】该待确认项已不适用，出处 OSD-116 c50472。

Kent 原文：「no longer applies — any resolution failure = stop + alert」
