...
> **上次同步日期**：2026-09-23（对照来源页 lastModified: Sep 05, 2026，**v25**，脚本机械比对，含表头与列数）：§一 4 行／4 列、§五 6 行／4 列、§六 15 行／4 列，三张表的表头与每一行全部逐字一致，无漂移。与来源页不一致时，以 Confluence 当前版本为准，本文件视为过期。
