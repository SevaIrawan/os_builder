...
> **上次同步日期**：2026-09-17（对照来源页 lastModified: Sep 15, 2026）
...
- **动手前按** [07.06.1｜开发规则与避坑指南](https://nexmax.atlassian.net/wiki/spaces/NOSM/pages/1712226375) **第三节主题速查表**命中本次任务相关条目并实际读取——本次要动的是数据写入、通知外发、共享对象还是发布上线，对应条目在动手前读，不是出事后才查。
