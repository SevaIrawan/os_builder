...
> **上次同步日期**：2026-09-23（对照来源页 lastModified: Sep 15, 2026，**v30**；本次以脚本逐字比对：§八 19 条 bullet 全部逐字一致、preamble 一致、「开发入口的冻结要求」全段一致，无漂移。比对方法：markdown 链接还原为文字、去 `**`／反引号／反斜杠／全部空白后做全等判断）
